...
module(
  'Integration | Helper | ember-sundries/string-replace',
  function (hooks) {
    ...
    test('Replaces only first instance without flag "g"', async function (assert) {
      ...
      await render(
        hbs`{{ember-sundries/string-replace inputValue find="-" replace="*"}}`
      );
    ...
    test('Replaces globally with flag "g"', async function (assert) {
      ...
      await render(
        hbs`{{ember-sundries/string-replace inputValue find="-" replace="*" flags="g"}}`
      );
    ...
    test('Case insensitive with flag "i"', async function (assert) {
      ...
      await render(
        hbs`{{ember-sundries/string-replace inputValue find="f" replace="*" flags="i"}}`
      );
    ...
    test('Case sensitive without flag "i"', async function (assert) {
      ...
      await render(
        hbs`{{ember-sundries/string-replace inputValue find="f" replace="*"}}`
      );
    ...
    test('With flags "gi"', async function (assert) {
      ...
      await render(
        hbs`{{ember-sundries/string-replace inputValue find="f" replace="*" flags="gi" }}`
      );
